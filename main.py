...
class ClusterSimulator:
    def __init__(self, num_machines=2, num_resources=3, num_slots=4, num_jobs=3):
        self._machines_usage = np.zeros((num_machines, num_resources, num_slots), dtype=np.int32)
        self._jobs_usage = np.zeros((num_machines, num_resources, num_slots), dtype=np.int32)
